...
public class KnowNERYagoDictionaryCheckerIntegrationTest {
	...
	public void shouldReturnSuccessWhenNoFileExistsAndCreateNew() throws Exception {
		KnowNERResourceResult result = new KnowNERYagoDictionaryChecker(tempMainDir.toString(), language, dataProvider, true).check();
	...
	public void shouldReturnSuccessWhenFileExistsAndCreateNew() throws Exception {
		Files.write(Paths.get(tempMainDir.toString(), language,
				KnowNERLocalResourceChecker.getAidaPrefix() + KnowNERYagoDictionaryChecker.FILE_SUFFIX),
				("Richard Anconina\n" +
						"Geh̦rgangsexostose\n" +
						"Bugatti EB110\n" +
						"Vesna Zmijanac\n" +
	...
	public void shouldReturnSuccessWhenFileExistsAndNotCreateNew() throws Exception {
		Files.write(Paths.get(tempMainDir.toString(),
				KnowNERLocalResourceChecker.getAidaPrefix() + KnowNERYagoDictionaryChecker.FILE_SUFFIX),
				("Richard Anconina\n" +
						"Geh̦rgangsexostose\n" +
						"Bugatti EB110\n" +
		...
		KnowNERResourceResult result = new KnowNERYagoDictionaryChecker(tempMainDir.toString(), language, dataProvider, false).check();
		assertTrue(result.isSuccess());
