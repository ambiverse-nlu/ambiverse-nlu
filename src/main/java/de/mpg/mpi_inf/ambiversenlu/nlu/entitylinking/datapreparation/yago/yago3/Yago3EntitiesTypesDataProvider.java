...
public class Yago3EntitiesTypesDataProvider extends EntitiesTypesEntriesDataProvider {

  private YAGO3Reader yago3Reader;

  public Yago3EntitiesTypesDataProvider(YAGO3Reader yago3Reader) {
    this.yago3Reader = yago3Reader;
  }

  private Multimap<String, String> run() throws IOException {
    List<Fact> typesRelationSet = yago3Reader.getFacts(YAGO3RelationNames.type);
