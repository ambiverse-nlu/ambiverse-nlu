package de.mpg.mpi_inf.ambiversenlu.nlu.entitylinking.service.web.resource.support;
...
public abstract class ResponseWrapper extends Response {
  ...
  @Override public <T> T readEntity(final GenericType<T> entityType) {
    return delegate.readEntity(entityType);
  }

  @Override public <T> T readEntity(final Class<T> entityType, final Annotation[] annotations) {
  ...
  @Override public <T> T readEntity(final GenericType<T> entityType, final Annotation[] annotations) {
    return delegate.readEntity(entityType, annotations);
  }
  ...
  @Override public boolean hasLink(final String relation) {
    return delegate.hasLink(relation);
  }

  @Override public Link getLink(final String relation) {
