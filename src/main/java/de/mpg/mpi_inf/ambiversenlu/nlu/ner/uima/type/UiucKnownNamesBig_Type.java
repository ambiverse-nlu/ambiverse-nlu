 ...
 *  */
public class UiucKnownNamesBig_Type extends Annotation_Type {
  /**
  ...
  public final static int typeIndexID = UiucKnownNamesBig.typeIndexID;
    @SuppressWarnings ("hiding")
  public final static boolean featOkTst = JCasRegistry.getFeatOkTst("UiucKnownNamesBig");
  ...
  /** initialize variables to correspond with Cas Type and Features
	 ...
	 * @param casType Type 
	 */
  public UiucKnownNamesBig_Type(JCas jcas, Type casType) {
    super(jcas, casType);
