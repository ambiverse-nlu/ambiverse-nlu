...
public class D {
  ...
  @SuppressWarnings({ "unchecked", "rawtypes" }) public static <K, V, C extends Collection<V>, L extends Collection> void addKeyValue(Map<K, C> map,
      K key, V value, Class<L> collectionType) {
    C coll = map.get(key);
    if (coll == null) {
      try {
  ...
  /** Given a map that maps to collections, adds a new key/value pair or introduces the key*/
  @SuppressWarnings({ "rawtypes" }) public static <K, V, C extends Collection<V>, L extends Collection> void addKeyValues(Map<K, C> map, K key,
      C values, Class<L> collectionType) {
  ...
  @SuppressWarnings({ "unchecked", "rawtypes" }) public static int comparePairs(Object... o) {
