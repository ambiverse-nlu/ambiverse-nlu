 ...
 *  */
public class Relation_Type extends Constituent_Type {
  /**
  ...
  public final static int typeIndexID = Relation.typeIndexID;
    @SuppressWarnings ("hiding")
  public final static boolean featOkTst = JCasRegistry.getFeatOkTst("de.mpg.mpi_inf.ambiversenlu.nlu.entitylinking.uima.type.Relation");
