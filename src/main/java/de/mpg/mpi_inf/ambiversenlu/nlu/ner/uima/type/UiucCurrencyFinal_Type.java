 ...
 *  */
public class UiucCurrencyFinal_Type extends Annotation_Type {
  /**
  ...
  public final static int typeIndexID = UiucCurrencyFinal.typeIndexID;
    @SuppressWarnings ("hiding")
  public final static boolean featOkTst = JCasRegistry.getFeatOkTst("UiucCurrencyFinal");
  ...
  /** initialize variables to correspond with Cas Type and Features
	 ...
	 * @param casType Type 
	 */
  public UiucCurrencyFinal_Type(JCas jcas, Type casType) {
    super(jcas, casType);
