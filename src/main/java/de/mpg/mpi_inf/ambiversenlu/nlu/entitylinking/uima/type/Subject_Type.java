 ...
 *  */
public class Subject_Type extends Constituent_Type {
  /**
  ...
  public final static int typeIndexID = Subject.typeIndexID;
    @SuppressWarnings ("hiding")
  public final static boolean featOkTst = JCasRegistry.getFeatOkTst("de.mpg.mpi_inf.ambiversenlu.nlu.entitylinking.uima.type.Subject");
