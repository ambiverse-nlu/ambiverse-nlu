 ...
 *  */
public class UiucKnownPlace_Type extends Annotation_Type {
  /**
  ...
  public final static int typeIndexID = UiucKnownPlace.typeIndexID;
    @SuppressWarnings ("hiding")
  public final static boolean featOkTst = JCasRegistry.getFeatOkTst("UiucKnownPlace");
  ...
  /** initialize variables to correspond with Cas Type and Features
	 ...
	 * @param casType Type 
	 */
  public UiucKnownPlace_Type(JCas jcas, Type casType) {
    super(jcas, casType);
