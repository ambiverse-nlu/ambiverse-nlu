...
import de.mpg.mpi_inf.ambiversenlu.nlu.entitylinking.datapreparation.test.TestDictionaryEntriesDataProvider;
...
public class TestDataPrepConf extends DataPrepConf {

  @Override public List<DictionaryEntriesDataProvider> getDictionaryEntriesProvider() {
    List<DictionaryEntriesDataProvider> provs = new ArrayList<>();
    provs.add(new TestDictionaryEntriesDataProvider(false));
    return provs;
  }

  @Override public List<DictionaryEntriesDataProvider> getDictionaryEntriesProviderToComputePrior() {
    List<DictionaryEntriesDataProvider> provs = new ArrayList<>();
    provs.add(new TestDictionaryEntriesDataProvider(true));
    return provs;
  }
